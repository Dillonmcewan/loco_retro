...
- **Retro content is stored unencrypted** in the Cloudflare Durable Object backing each room, and in each participant's browser IndexedDB. Don't paste secrets, credentials, or sensitive personal data into cards.
