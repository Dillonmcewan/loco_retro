...
2. Re-read the relevant sections of `docs/architecture.md`. The dev plan supersedes anything older in the feature plan; if they conflict, raise it before coding.
...
- If you make a non-trivial decision during implementation (a library choice, a schema shape, a new convention), update `docs/architecture.md` in the **same commit** that introduces it.
...
- `docs/architecture.md` reflects any new decisions.
