...
Each feature plan is a contract between the PRD (`../prd.md`), the dev plan (`../plan.md`), and the code that gets written. It is produced by the `/feature-plan` slash command and consumed by `/implement`.
...
- **Design** — the approach, how it aligns with `../plan.md`, and alternatives considered.
